...
boss. Well, maybe. I had the pleasure of consulting^ for different busineses on
whether node.js is the right technology, and sometimes the answer is simply no.

So this guide is my oppinonated collection of advice for those of you that want
...
software, artificial intellegence or similar CPU hungry software, please do not
...
applications, you shouldn't expect it do provide you with more benefits than
PHP, Ruby or Python at this point. Yes, your app might end up slightly more
scalable, but no - you're app will not magically get more traffic just because
...
will not provide many tangingable business benefits yet.
...
Sure, there are legitmate use cases for choosing a document oriented database.
...
shines. It's non-blocking I/O model combined with JavaScript make it a great
choice for wrapping other data sources such as datbases or web services and
...
can be build to take advantage of this fact. One great example is parsing file
uploads in real time^, as well as building proxies between different data
layers.

### Yes: Soft Realtime Applications

Another great aspects of node.js is the ease at which you can develop soft real
...
The best way to your foot into the door, is to suggest taking a week to build a
simple prototype of a certain part of the application you have in mind. It's
usually easy to get management to agree to that, since they don't have to make a
long term commitment yet.
...
lingua franca^ of computer programming. Pretty much every personal computer has
one or more JavaScript interpreters (browsers) installed, which means it's
almost impossible for most web developers to learn it at some point in their
career.
...
commitement by it's authors. This isn't the case with node.js. Node is currently
...
dependent on your judgement, as well as continous support for the software you
create for them.
